...
<div class="wrap crocOptions">
	...
	<form name="form" method="post" action="">
		...
		<input size=25 type="text" name="api-key_input" value="<?php echo $key_option_val; ?>" size="20"> <a class="get-token" href="https://crocodoc.com/dashboard/" target="_blank">Get Token</a></p>
